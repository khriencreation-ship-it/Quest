    ...
    if (isCompanyLevel) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Select a department</h2>
                <p className="text-gray-500 max-w-sm mb-8">
                    To view and manage internal tasks, please select a department from the left sidebar switcher.
                </p>
