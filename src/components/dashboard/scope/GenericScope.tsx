...
export default function GenericScope({ initialConfig, onClose, onSave }: Props) {
    ...
    return (
        <div className="space-y-4">
            {/* 1. Categories */}
            <SectionCard title="1. Service Categories" icon={<Layers className="w-4 h-4" />}>
            ...
            {/* 2. Deliverables */}
            <SectionCard title="2. Deliverables & Volume" icon={<FileText className="w-4 h-4" />}>
            ...
            {/* 3. Turnaround */}
            <SectionCard title="3. Turnaround & Scheduling" icon={<Clock className="w-4 h-4" />}>
            ...
            {/* 4. Revisions */}
            <SectionCard title="4. Revision Policy" icon={<Repeat className="w-4 h-4" />} defaultOpen={false}>
                <div className="space-y-4">
                    <div>
            ...
            {/* 5. Delivery */}
            <SectionCard title="5. File Delivery" icon={<Layout className="w-4 h-4" />} defaultOpen={false}>
            ...
            {/* 6. Legal / Rights */}
            <SectionCard title="6. Usage Rights" icon={<ShieldCheck className="w-4 h-4" />} defaultOpen={false}>
            ...
            {/* 7. Retainer */}
            <SectionCard title="7. Retainer Structure" icon={<Repeat className="w-4 h-4" />} defaultOpen={false}>
                <div className="space-y-4">
