...
import { updateDocumentName } from '@/app/actions/documents';
...
export default function EditDocumentModal({
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        const result = await updateDocumentName(documentId, newName.trim(), projectId);
            ...
            >
                <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50/50">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Change the display name of your file.</p>
                    </div>
                    <button
                        onClick={onClose}
