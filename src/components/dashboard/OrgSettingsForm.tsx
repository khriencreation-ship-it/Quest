...
export default function OrgSettingsForm({ organization }: Props) {
  ...
  async function handleDelete() {
    if (
      !confirm(
        `Are you sure you want to delete the "${organization.name}" department? This action cannot be undone.`,
      )
    ) {
      return;
    }
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Manage the name and description of this department.
            </p>
          </div>
          {!isEditing && (
            <button
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-red-700/80 mt-1">
              Permanently delete this department and all its data.
            </p>
          </div>
          <button
            ...
            title={
              organization.name === "General"
                ? "You cannot delete the General department"
                : "Delete department"
            }
